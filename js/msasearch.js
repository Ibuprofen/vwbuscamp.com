...
function showStateProvinces($country) {

	if ($country == "US") {
		document.getElementById('usstates').style.display = 'block';
		document.getElementById('nonusstates').style.display = 'none';
		
	} else {
		document.getElementById('usstates').style.display = 'none';
		document.getElementById('nonusstates').style.display = 'block';
	}
